...
void VerAfectoCarinio::llenarDescripcion()
{
    descripcion[0]="1. Despido a mi hijo/a diariamente\n    con un abrazo o un beso..........\n";
    descripcion[1]="2. Siempre lo despierto cariñosamente..........\n";
    descripcion[2]="3. Nunca lo regaño antes de irse a la escuela..........\n";
    descripcion[3]="4. Nunca lo insulto con palabras soeces..........\n";
    descripcion[4]="5. Le digo te quiero o te amo diariamente..........\n";
    descripcion[5]="6. Siempre se por que llora..........\n";
}

string VerAfectoCarinio::mostrarDescripcion(int c,string ac_descripcion)
{
    if(c < 6){
...
int VerAfectoCarinio::devolverIngreso(sf::String ingreso)
{
    string convert;
    convert = ingreso;
...
int VerAfectoCarinio::ventana(){
    ...
    back_ingreso6.setPosition(500,395);
    ...
    txt_ingreso6.setFont(font);txt_ingreso6.setCharacterSize(20);txt_ingreso6.setColor(sf::Color::Black);txt_ingreso6.setPosition(505,398);
    ...
    while (window.isOpen())
    {
        ...
        txt_Title.setString("AFECTO Y CARIÑO");
